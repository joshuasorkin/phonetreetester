...
//creates call to host,
//and returns Twiml for sending guest to conference
//this function is only called when the guest initially requests their host,
//when other host requests are made (in response to host refusing),
//only createCallToHost() is called (in ivr/statusChange)
